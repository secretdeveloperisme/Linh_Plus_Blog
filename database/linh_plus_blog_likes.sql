...
CREATE TABLE `likes` (
  ...
  UNIQUE KEY `Likes_PostId_UserId_unique` (`post_id`,`user_id`),
  KEY `user_id` (`user_id`),
...
INSERT INTO `likes` VALUES (1,1,'like'),(2,1,'like'),(3,1,'like'),(3,2,'like'),(3,4,'like'),(6,1,'like'),(6,2,'like'),(7,1,'like'),(7,2,'like'),(10,1,'like'),(10,2,'like'),(11,1,'like'),(13,1,'like');
