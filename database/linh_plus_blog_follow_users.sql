...
CREATE TABLE `follow_users` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `follow_users_ibfk_1` FOREIGN KEY (`follower_id`) REFERENCES `users` (`id`)ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `follow_users_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `follow_users` VALUES (2,1),(1,2),(3,2),(1,3);
