...
CREATE TABLE `comment_likes` (
  ...
  UNIQUE KEY `comment_likes_UserId_CommentId_unique` (`comment_id`,`user_id`),
  KEY `user_id` (`user_id`),
...
INSERT INTO `comment_likes` VALUES (1,1,'like'),(2,1,'like'),(3,1,'like'),(5,1,'like'),(6,1,'like');
...
-- Dump completed on 2022-05-07 15:17:53
